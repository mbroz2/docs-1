...
To enable the MicroProfile Metrics 2.0 feature, add the following element declaration into your `server.xml` file, inside the `featureManager` element:
...
[source,]
----
com.ibm.websphere.appserver.mpMetrics-2.0; type="osgi.subsystem.feature"
----
// end::feature-require[]
// tag::spi[]
// end::spi[]
